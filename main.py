...
class Bot(commands.Bot):
    def __init__(self, cmd_store, admin_channel_name, log_channel_name):
        super().__init__(command_prefix=cmd_setter.PREFIX)
        # TODO because the bot isn't connected yet, self.user is still none. Fix.
        self.add_cog(
            cmd_setter.CommandSetter(self.user, cmd_store, admin_channel_name))
...
def _main():
    ...
    newton = Bot(cmd_db, admin_channel, log_channel)
